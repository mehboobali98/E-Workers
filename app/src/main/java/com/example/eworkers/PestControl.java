 ...
 * Use the {@link PestControl#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PestControl extends Fragment {
     ...
     * @return A new instance of fragment PestControl.
     */
    // TODO: Rename and change types and number of parameters
    public static PestControl newInstance(String param1, String param2) {
        PestControl fragment = new PestControl();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_pest_control, container, false);
        Button butt = (Button)  root.findViewById(R.id.next);
        butt.setOnClickListener(new View.OnClickListener() {
            @Override

            public void onClick(View v) {
                Spinner sp = (Spinner) root.findViewById(R.id.area9);
